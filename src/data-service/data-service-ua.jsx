        ...
        {   
            works: [
                {   
                    ...
                    Зустрічаються дублікати компонентів, тому що при створенні ще не освоїв правильну техніку 
                    перевикористання компонентів. Для даного типу макета інструмент React - не краще рішення`,
